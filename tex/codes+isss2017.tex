...
\begin{itemize}
\item \textbf{IO cores}: IO cores are connected to a 16-banked parallel shared memory with a total capacity (IO SMEM) of 2 MB, as shown on the left-hand side of Figure \ref{fig:mppa_architecture},
