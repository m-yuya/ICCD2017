...
This is the reason why MPPA-256 ha succeeded in scaling the number of cores up to  256 cores.
However, the local shared memory architecture restricts the capacity of memory and needs a data copy from DDR with NoC.
This restriction makes use of extant applications difficult especially in the case of the applications which require more memory.
In terms of power efficiency, MPPA-256 realizes high energy efficiency despite a large number of cores.
...
MPPA-256 is typicall accepted with respect to many-core platforms and the model is used in several previous studies \cite{perret2016temporal}, \cite{becker2016contention}, \cite{carle2014static}, \cite{perret2016mapping} \cite{perret2016predictable}.
...
While theoretical analysis is done thoroughly, practical evaluations are poor and parallel data transfer does not be refered.
...
The authors like to thank Atsushi Matsuo and Masaki Gondo from eSOL and xxx from Kalray for their support which helped to improve this work.
