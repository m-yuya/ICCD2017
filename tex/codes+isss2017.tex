...
However, the transport latencies are not quantitatively examined, and previous work has not clarified the potential and constraints for low-latency many-core computing.
...
These results allow system designers to choose appropriate data transfer methods based on the requirement of their latency-sensitive many-core applications beyond an intuitive expectation.
