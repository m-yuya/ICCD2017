...
As shown in Figure \ref{fig:ndt_matching}, the evaluation of parallelized self-localization algorithm indicates the average execution time for each convergence and clarifies that the parallelization accelerates the process of \emph{Derivatives}.
...
The authors would like to thank Atsushi Matsuo and Masaki Gondo from eSOL, and Gilbert Richard and Stéphane Cordova from Kalray for their support which helped to improve this work.
