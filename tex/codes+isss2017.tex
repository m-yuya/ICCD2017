...
\title{\colorbox{green}{TBD: 1-2, 3-2} Exploring Data Transfer and Parallelization with NoC-based Many-Core Processors}
\begin{document}
...
\textbf{Contributions:}
\colorbox{green}{TBD: 1-1, 1-8, 1-9, 3-3: To be clarified}

This study focuses on examining the performance characteristics of currently achievable data transfer methods for many-core computing based on networks-on-chip (NoCs), such as MPPA-256, while examining parallel data transfer methods.
