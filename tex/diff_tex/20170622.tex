...
This study focuses on examining embedded many-core computing based on NoCs, such as MPPA-256.
...
To the best of our knowledge, this is the first study that examines data transfer and data allocation matters for many-core computing beyond an intuitive expectation to allow system designers to choose appropriate data transfer methods.
...
Second, the Kalray MPPA-256 which this study focuses on is compared to other COTS COTS multi/many-core components, and we summarize the features of MPPA-256.
